...
o.bind("SUPER + SHIFT + LEFT", "Move window out of group / swap left", "hypr-swap-or-ungroup l")
o.bind("SUPER + SHIFT + RIGHT", "Move window out of group / swap right", "hypr-swap-or-ungroup r")
o.bind("SUPER + SHIFT + UP", "Move window out of group / swap up", "hypr-swap-or-ungroup u")
o.bind("SUPER + SHIFT + DOWN", "Move window out of group / swap down", "hypr-swap-or-ungroup d")
